...
(this,function(){
  var d = document;var playSize=60;
  var Gifffer = function(options){
    var images,i=0,gifs=[];images=d.querySelectorAll("[data-gifffer]");
    for(;i<images.length;++i) process(images[i],gifs,options);
    return gifs;
  };
  function formatUnit(v){return v+(v.toString().indexOf("%")>0?"":"px")}
  ...
  function createContainer(w,h,el,altText,opts){
    ...
    if(altText){
      alt = d.createElement("p");alt.setAttribute("class","gifffer-alt");
    ...
    el.onload = function(){
      ...
      con.addEventListener("click",function(){
        ...
        if(!playing){
          ...
          setTimeout(function(){gif.src=url}, 0);
